...
function toggleDropdown(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) {
  ...
  function handleSignOut() {
    logout();                      // 1. clear context
    router.push("/signin");        // 2. redirect
  }
  const { name, email,imageUrl } = authData.user;
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="mr-3 relative overflow-hidden rounded-full h-11 w-11">
  <Image
